...
CROWNは新型機にも特別な復帰演出にも乗らず、古いF-15Cで青い編隊へ戻った。白いARCAは戦場を去ろうとしている。追う理由があるかを決めるのは命令ではなく、護衛半径から離れるRAVEN自身の航跡だ。`,
    ...
    sequence: [
      { types: ["jammer"], tgt: true, band: 1, idBase: 1930, label: "CEASEFIRE JAMMER", missionTag: "m19Attackers", role: "support", skill: "regular", at: [...anchors.northIntercept], altitude: 5600, facing: [...anchors.convoyStart] },
      { types: ["mig29", "mig29", "mig29", "mig29"], tgt: true, concurrent: true, delay: 2, band: 1, idBase: 1940, label: "FULCRUM RAID 1", missionTag: "m19Attackers", role: "line", skill: "regular", hunt: "air", at: [...anchors.westIntercept], altitude: 2300, facing: [...anchors.convoyStart] },
      { types: ["s70", "s70", "s70", "s70"], tgt: true, concurrent: true, delay: 28, band: 1, idBase: 1950, label: "HUNTER UCAV", missionTag: "m19Attackers", role: "evasive", skill: "regular", hunt: "air", at: [...anchors.eastIntercept], altitude: 2800, facing: [...anchors.convoyStart] },
      { types: ["su35", "su35"], tgt: true, concurrent: true, delay: 58, band: 2, idBase: 1960, label: "FLANKER RAID 1", missionTag: "m19Attackers", role: "line", skill: "veteran", hunt: "air", at: [9000, -2500], altitude: 3300, facing: [...anchors.battleCenter] },
      { types: ["mig29", "mig29"], tgt: true, concurrent: true, delay: 84, band: 2, idBase: 1970, label: "FULCRUM RAID 2", missionTag: "m19Attackers", role: "line", skill: "veteran", hunt: "air", at: [...anchors.lowIntercept], altitude: 1900, facing: [...anchors.battleCenter] },
      { types: ["su35", "su35"], tgt: true, concurrent: true, delay: 112, band: 2, idBase: 1980, label: "FLANKER RAID 2", missionTag: "m19Attackers", role: "evasive", skill: "veteran", hunt: "air", at: [-9200, -5600], altitude: 3600, facing: [...anchors.battleCenter] },
      { types: ["su57"], tgt: true, concurrent: true, delay: 142, band: 3, idBase: 1990, label: "CEASEFIRE BREAKER", missionTag: "m19Attackers", role: "evasive", skill: "ace", hunt: "air", at: [0, -14600], altitude: 4300, facing: [...anchors.battleCenter] },
      { types: ["f3", "f3", "f3", "f3"], tgt: false, rankNeutral: true, concurrent: true, delay: 168, band: 3, idBase: 2000, label: "ARCA WITHDRAWAL", missionTag: "m19ArcaRetreat", role: "evasive", skill: "veteran", at: [...anchors.arcaEntry], altitude: 4100, facing: [...anchors.arcaExit] }
    ],
    m19TrustContract,
    fixedRadio: [
      { id: "m19_intro_01", at: 2, speaker: "meridian", priority: "NORMAL", text: "停戦・復旧団四機、ミガル外環回廊へ進入。輸送機一、分散作業ドローン三を一本のHPで表示する。" },
      { id: "m19_crown_return", at: 6, speaker: "crown", priority: "NORMAL", text: "CROWN、青編隊へ復帰する。挨拶は着陸してからだ。輸送の右を受け持つ。" },
      { id: "m19_lark", at: 10, speaker: "lark", priority: "NORMAL", text: "CROWNはF-15C、私はF-15E。いつもの青い三角が二つ増えただけ——護衛に集中しよう。" },
      { id: "m19_arca", event: "m19ArcaWithdrawal", speaker: "meridian", priority: "URGENT", text: "白いARCA四、撤退航路を横断。NON-TGT、追撃不要。停戦輸送から離れるな。" },
    ...
    successRadio: { speaker: "meridian", priority: "CRITICAL", text: "停戦・復旧団の外環航路を確保。TRUST FALL完了、全機ミガル中枢へ。", id: "m19-success" },
