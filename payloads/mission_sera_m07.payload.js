...
//
// M06 is not on the current implementation branch. This mission keeps its
// canonical campaign/story number and is inserted after the latest Sera sortie;
// a later M06 insert after M05 naturally moves this mission one slot down.
export default function register(ctx) {
  ...
  if (!MISSIONS.some((mission) => mission.key === "sera-m05" && mission.campaign === "sera")) {
    throw new Error("[sera-m07] latest implemented Sera predecessor sera-m05 is missing");
  }
