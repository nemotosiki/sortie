...
// three mission insertions that the payload registry can safely express.
//
// r07's maritime-patrol aircraft is registered below, but is deliberately not
// put into sequence[] as an enemy. At base 16e54a9 the friendly roster lives in
// the frozen, private FRIENDLY_DEPLOYMENTS table, which is not exposed through
// the payload context. Faking the patrol aircraft as tgt:false would still put
// it in enemies[] (lockable, killable and scored), the opposite of a guard
// target. See the delivery report for the small host-side registration gap.
//
