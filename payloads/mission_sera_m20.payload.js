...
ROOKはRAVEN、CROWN、LARKの三機で最後の防空線へ上がる。ここで守るのはROOTの所有権ではない。翌朝を戦争の続きにしないための、ただ一つの空域だ。`,
    ...
    sequence: [
      ...
      { types: ["mig29", "mig29"], tgt: true, concurrent: true, delay: 18, band: 1, idBase: 2030, label: "FULCRUM PIN", missionTag: "m20FinalDefence", role: "line", skill: "veteran", purpose: "pinning", at: [...anchors.westLane], altitude: 3300, facing: [...anchors.battleCenter] },
      { types: ["mig29", "mig29", "mig29", "mig29"], tgt: true, concurrent: true, delay: 22, band: 1, idBase: 2032, label: "FULCRUM WALL", missionTag: "m20FinalDefence", role: "line", skill: "veteran", purpose: "intercept", at: [...anchors.westLane], altitude: 3500, facing: [...anchors.battleCenter] },
