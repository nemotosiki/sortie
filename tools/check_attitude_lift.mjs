...
for (const required of [
  'from "./src/flight/flight-dynamics.js?v=20260828-unified-flight-5"',
  "FLIGHT_GRAVITY_MPS2,",
...
assert(!indexSource.includes('from "./src/flight/attitude-lift.js')
    && !indexSource.includes('from "./src/flight/stall-translation.js'),
  "superseded split flight kernels are still wired into production");
